...
class NumericProcessor(DataProcessor):
    ...
    def format_output(self, result: str) -> str:
        ...
        try:
            ...
            return (f"Output: Processed {lenght_data}"
                    f" numeric values, sum={sum_data}, avg={float(avg)}")
        except TypeError:
            return "all have to be of type int"
...
class TextProcessor(DataProcessor):
    ...
    def format_output(self, result: str) -> str:
        ...
        return (f"Output: Processed text :"
                f"{length_text} characters, {nbr_of_word} words")
...
class LogProcessor(DataProcessor):
    ...
    def process(self, data: Any) -> str:
        ...
        try:
            if 'ERROR' in data:
                raise Exception("onnection timeout")
            return (f'Processing data : "{data}" ')
        except Exception as e:
